...
export default function Home() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      ...
      <div className={`bg-gray-800/50 backdrop-blur-sm rounded-xl p-8 mb-8 border border-gray-700 transition-all duration-300 ${detailMode ? 'hidden' : ''}`}>
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-semibold">フィルター設定</h2>
        ...
        <div className="text-center">
          <button
            ...
            disabled={loading || isOnCooldown || remainingRequests === 0}
            aria-label="トーク台本を生成"
